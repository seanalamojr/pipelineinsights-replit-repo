-- Run manually in Database -> Production -> My Data -> SQL runner.
-- This aligns the derived reporting view without deleting or changing base rows.
-- Take/confirm a production recovery point first.
...
-- Verification: this hash should match development after the SQL is run.
SELECT md5(pg_get_viewdef('public.vw_fact_player_prop_odds'::regclass, true))
    AS reporting_view_hash;