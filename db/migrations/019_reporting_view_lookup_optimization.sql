-- Card E performance: avoid repeating feature and injury lookups once per
-- prediction row while preserving the reporting view's column contract.
...
VALUES ('019_reporting_view_lookup_optimization')
